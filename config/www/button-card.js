        ...
        if ((u++, 1 === t.nodeType)) {
          if (t.hasAttributes()) {
            const e = t.attributes,
              { length: i } = e;
            let n = 0;
            for (let t = 0; t < i; t++) o(e[t].name, '$lit$') && n++;
            for (; n-- > 0; ) {
              const e = p[d],
                i = h.exec(e)[2],
                n = i.toLowerCase() + '$lit$',
              ...
              t.removeAttribute(n);
              const a = r.split(s);
              this.parts.push({ type: 'attribute', index: u, name: i, strings: a }),
                (d += a.length - 1);
            }
          }
          ...
          if (e.indexOf(n) >= 0) {
            ...
            for (let e = 0; e < a; e++) {
              ...
              if ('' === s) i = c();
                ...
                null !== t &&
                  o(t[2], '$lit$') &&
                  (s = s.slice(0, t.index) + t[1] + t[2].slice(0, -'$lit$'.length) + t[3]),
                  (i = document.createTextNode(s));
              }
              n.insertBefore(i, t), this.parts.push({ type: 'node', index: ++u });
            }
            '' === r[a] ? (n.insertBefore(c(), t), i.push(t)) : (t.data = r[a]), (d += a);
          }
        } else if (8 === t.nodeType)
          if (t.data === n) {
            const e = t.parentNode;
            (null !== t.previousSibling && u !== l) || (u++, e.insertBefore(c(), t)),
              (l = u),
              this.parts.push({ type: 'node', index: u }),
              null === t.nextSibling ? (t.data = '') : (i.push(t), u--),
              d++;
          } else {
            let e = -1;
...
function u(t, e) {
  ...
  for (; r.nextNode(); ) {
    ...
    for (
      ...
      (a.index = null !== h ? -1 : a.index - l), (s = p(n, s)), (a = n[s]);
  }
  ...
  _clone() {
    ...
    for (; a < n.length; )
      if (((s = n[a]), l(s))) {
        for (; o < s.index; )
          o++,
            'TEMPLATE' === c.nodeName && (i.push(c), (r.currentNode = c.content)),
            null === (c = r.nextNode()) && ((r.currentNode = i.pop()), (c = r.nextNode()));
        if ('node' === s.type) {
          const t = this.processor.handleTextExpression(this.options);
          t.insertAfterNode(c.previousSibling), this.__parts.push(t);
        } else
          this.__parts.push(
            ...this.processor.handleAttributeExpressions(c, s.name, s.strings, this.options)
          );
        a++;
...
const v = window.trustedTypes && trustedTypes.createPolicy('lit-html', { createHTML: (t) => t }),
  w = ` ${n} `;
class S {
  constructor(t, e, i, n) {
  ...
  getHTML() {
    ...
    for (let s = 0; s < t; s++) {
      const t = this.strings[s],
        a = t.lastIndexOf('\x3c!--');
      i = (a > -1 || i) && -1 === t.indexOf('--\x3e', a + 1);
      const o = h.exec(t);
      e += null === o ? t + (i ? w : r) : t.substr(0, o.index) + o[1] + o[2] + '$lit$' + o[3] + n;
    }
...
class O {
  constructor(t, e, i) {
    ...
    for (let n = 0; n < i.length - 1; n++) this.parts[n] = this._createPart();
  }
  _createPart() {
    return new T(this);
  }
  _getValue() {
    ...
    for (let r = 0; r < e; r++) {
      ...
      if (void 0 !== e) {
        const t = e.value;
        if (x(t) || !k(t)) n += 'string' == typeof t ? t : String(t);
...
const j = (t) => t && (N ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
function $(t) {
  let e = H.get(t.type);
  void 0 === e && ((e = { stringsArray: new WeakMap(), keyString: new Map() }), H.set(t.type, e));
  let i = e.stringsArray.get(t.strings);
  if (void 0 !== i) return i;
  const r = t.strings.join(n);
  return (
    (i = e.keyString.get(r)),
    void 0 === i && ((i = new a(t, t.getTemplateElement())), e.keyString.set(r, i)),
...
const V = new (class {
  handleAttributeExpressions(t, e, i, n) {
    ...
    if ('@' === r) return [new P(t, e.slice(1), n.eventContext)];
    if ('?' === r) return [new C(t, e.slice(1), i)];
    return new O(t, e, i).parts;
  }
...
const I = (t) => (e) => {
    const i = L(e.type, t);
    let r = H.get(i);
    void 0 === r && ((r = { stringsArray: new WeakMap(), keyString: new Map() }), H.set(i, r));
    let s = r.stringsArray.get(e.strings);
    if (void 0 !== s) return s;
    const o = e.strings.join(n);
    if (((s = r.keyString.get(o)), void 0 === s)) {
      const i = e.getTemplateElement();
      F && window.ShadyCSS.prepareTemplateDom(i, t), (s = new a(e, i)), r.keyString.set(o, s);
    }
  ...
  q = (t, e, i) => {
    ...
    const n = i ? i.element : document.createElement('template'),
      ...
      { length: s } = r;
    if (0 === s) return void window.ShadyCSS.prepareTemplateStyles(n, t);
    ...
    i
      ? (function (t, e, i = null) {
          ...
          const s = document.createTreeWalker(n, 133, null, !1);
          let a = p(r),
            o = 0,
            l = -1;
          for (; s.nextNode(); )
            for (
              l++, s.currentNode === i && ((o = d(e)), i.parentNode.insertBefore(e, i));
              -1 !== a && r[a].index === l;

            ) {
              if (o > 0) {
                for (; -1 !== a; ) (r[a].index += o), (a = p(r, a));
                return;
              }
              a = p(r, a);
            }
...
const Y = {
  ...
  B = (t, e) => e !== t && (e == e || t == t),
  W = { attribute: !0, type: String, converter: Y, reflect: !1, hasChanged: B };
class G extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, i) {
    return {
      ...
      set(n) {
        const r = this[t];
        (this[e] = n), this.requestUpdateInternal(t, r, i);
      },
      configurable: !0,
      enumerable: !0,
    };
  ...
  static _valueHasChanged(t, e, i = B) {
    return i(t, e);
  }
  ...
  static _propertyValueToAttribute(t, e) {
    ...
    const i = e.type,
      n = e.converter;
    return ((n && n.toAttribute) || Y.toAttribute)(t, i);
  }
  initialize() {
    (this._updateState = 0),
  ...
  _propertyToAttribute(t, e, i = W) {
    const n = this.constructor,
      r = n._attributeNameForProperty(t, i);
    if (void 0 !== r) {
...
const X = (t, e, i) => {
  ...
  K = (t, e) => ({ kind: 'method', placement: 'prototype', key: e.key, descriptor: t });
const Q =
    window.ShadowRoot &&
  ...
  (nt.render = (t, e, n) => {
    ...
    if (
      (((t, e, n) => {
        ...
        void 0 === r &&
          (i(e, e.firstChild),
          R.set(e, (r = new M(Object.assign({ templateFactory: $ }, n)))),
          r.appendInto(e)),
          r.setValue(t),
          r.commit();
      })(t, l, Object.assign({ templateFactory: I(r) }, n)),
      o)
    ) {
      const t = R.get(l);
      R.delete(l);
      const n = t.value instanceof y ? t.value.template : void 0;
      q(r, l, n), i(e, e.firstChild), e.appendChild(l), R.set(e, t);
    }
...
const st = new WeakMap(),
  at = g((t) => (e) => {
    ...
    const { committer: i } = e,
      { style: n } = i.element;
    let r = st.get(e);
    void 0 === r && ((n.cssText = i.strings.join(' ')), st.set(e, (r = new Set()))),
      r.forEach((e) => {
        e in t || (r.delete(e), -1 === e.indexOf('-') ? (n[e] = null) : n.removeProperty(e));
      });
    for (const s in t) r.add(s), -1 === s.indexOf('-') ? (n[s] = t[s]) : n.setProperty(s, t[s]);
  }),
  ot = new WeakMap(),
  lt = g((t) => (e) => {
    if (!(e instanceof M)) throw new Error('unsafeHTML can only be used in text bindings');
    const i = ot.get(e);
    if (void 0 !== i && x(t) && t === i.value && e.value === i.fragment) return;
    const n = document.createElement('template');
    n.innerHTML = t;
    const r = document.importNode(n.content, !0);
    e.setValue(r), ot.set(e, { value: t, fragment: r });
  });
class ct {
  constructor(t) {
    (this.classes = new Set()), (this.changed = !1), (this.element = t);
    const e = (t.getAttribute('class') || '').split(/\s+/);
    for (const i of e) this.classes.add(i);
  }
  add(t) {
...
const ht = new WeakMap(),
  ut = g((t) => (e) => {
    ...
    const { committer: i } = e,
      { element: n } = i;
    let r = ht.get(e);
    void 0 === r && (n.setAttribute('class', i.strings.join(' ')), ht.set(e, (r = new Set())));
    const s = n.classList || new ct(n);
    r.forEach((e) => {
      e in t || (s.remove(e), r.delete(e));
    });
    for (const a in t) {
      const e = t[a];
      e != r.has(a) && (e ? (s.add(a), r.add(a)) : (s.remove(a), r.delete(a)));
    }
    'function' == typeof s.commit && s.commit();
  });
var dt = /d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,
  pt = '[^\\s]+',
  ft = /\[([^]*?)\]/gm;
function gt(t, e) {
...
var bt = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'],
  ...
  kt = {
    ...
    ZZ: function (t) {
      ...
      return (e > 0 ? '-' : '+') + xt(100 * Math.floor(Math.abs(e) / 60) + (Math.abs(e) % 60), 4);
    },
    Z: function (t) {
      var e = t.getTimezoneOffset();
      return (
        (e > 0 ? '-' : '+') + xt(Math.floor(Math.abs(e) / 60), 2) + ':' + xt(Math.abs(e) % 60, 2)
      );
    },
  },
  Ot = function (t) {
...
var Nt = function (t, e, i) {
  ...
  var n = [];
  e = (e = At[e] || e).replace(ft, function (t, e) {
    return n.push(e), '@@@';
  });
  var r = _t(_t({}, St), i);
  return (e = e.replace(dt, function (e) {
    return kt[e](t, r);
  })).replace(/@@@/g, function () {
    return n.shift();
  });
...
var Dt = 'hass:bookmark',
  Lt = ['closed', 'locked', 'off'],
  Ft = new Set(['fan', 'input_boolean', 'light', 'switch', 'group', 'automation']),
  It = function (t, e, i, n) {
    (n = n || {}), (i = null == i ? {} : i);
    var r = new Event(e, {
  ...
  zt = new Set(['call-service', 'divider', 'section', 'weblink', 'cast', 'select']),
  Ut = {
    alert: 'toggle',
    automation: 'toggle',
    climate: 'climate',
...
function Yt(t, e) {
  ...
  switch (t) {
    ...
    default:
      return console.warn('Unable to find icon for domain ' + t + ' (' + e + ')'), Dt;
  }
}
var Bt = function (t) {
    It(window, 'haptic', t);
  ...
  Wt = function (t, e) {
    return (function (t, e, i) {
      ...
      return t.callService(s, n, { entity_id: e });
    })(t, e, Lt.includes(t.states[e].state));
  },
  Gt = function (t, e, i, n, r) {
    var s;
    if (
      (r && i.double_tap_action
        ? (s = i.double_tap_action)
        : n && i.hold_action
        ? (s = i.hold_action)
        : !n && i.tap_action && (s = i.tap_action),
      s || (s = { action: 'more-info' }),
      !s.confirmation ||
        (s.confirmation.exemptions &&
          s.confirmation.exemptions.some(function (t) {
            return t.user === e.user.id;
          })) ||
        confirm(s.confirmation.text || 'Are you sure you want to ' + s.action + '?'))
    )
      switch (s.action) {
        case 'more-info':
          (s.entity || i.entity || i.camera_image) &&
            (It(t, 'hass-more-info', {
              entityId: s.entity ? s.entity : i.entity ? i.entity : i.camera_image,
            }),
            s.haptic && Bt(s.haptic));
          break;
        case 'navigate':
          s.navigation_path &&
            ((function (t, e, i) {
              void 0 === i && (i = !1),
                i ? history.replaceState(null, '', e) : history.pushState(null, '', e),
                It(window, 'location-changed', { replace: i });
            })(0, s.navigation_path),
            s.haptic && Bt(s.haptic));
          break;
        case 'url':
          s.url_path && window.open(s.url_path), s.haptic && Bt(s.haptic);
          break;
        case 'toggle':
          i.entity && (Wt(e, i.entity), s.haptic && Bt(s.haptic));
          break;
        case 'call-service':
          if (!s.service) return;
          var a = s.service.split('.', 2),
            o = a[0],
            l = a[1],
            c = Object.assign({}, s.service_data);
          'entity' === c.entity_id && (c.entity_id = i.entity),
            e.callService(o, l, c),
            s.haptic && Bt(s.haptic);
      }
  },
  ...
  Jt = {
    ...
    sensor: function (t) {
      ...
      if (e && e in Zt) return Zt[e];
      if ('battery' === e) {
        var i = Number(t.state);
        if (isNaN(i)) return 'hass:battery-unknown';
        var n = 10 * Math.round(i / 10);
        return n >= 100 ? 'hass:battery' : n <= 0 ? 'hass:battery-alert' : 'hass:battery-' + n;
      }
      var r = t.attributes.unit_of_measurement;
      return '°C' === r || '°F' === r ? 'hass:thermometer' : Yt('sensor');
    },
    input_datetime: function (t) {
      return t.attributes.has_date
...
const Xt = (t, e, i, n) => {
  ...
  Kt = (t, e) => {
    ...
    if (t && e && 'object' == typeof t && 'object' == typeof e) {
      ...
      if (Array.isArray(t)) {
        ...
        for (i = n; 0 != i--; ) if (!Kt(t[i], e[i])) return !1;
        return !0;
      }
      if (t instanceof Map && e instanceof Map) {
        if (t.size !== e.size) return !1;
        for (i of t.entries()) if (!e.has(i[0])) return !1;
        for (i of t.entries()) if (!Kt(i[1], e.get(i[0]))) return !1;
        return !0;
      }
      ...
      if (ArrayBuffer.isView(t) && ArrayBuffer.isView(e)) {
        if (((n = t.length), n !== e.length)) return !1;
        for (i = n; 0 != i--; ) if (t[i] !== e[i]) return !1;
        return !0;
      }
      ...
      for (i = n; 0 != i--; ) if (!Object.prototype.hasOwnProperty.call(e, r[i])) return !1;
      for (i = n; 0 != i--; ) {
        const n = r[i];
  ...
  Qt = 'ontouchstart' in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;
class te extends HTMLElement {
  ...
  connectedCallback() {
    Object.assign(this.style, {
      position: 'absolute',
      width: Qt ? '100px' : '50px',
      height: Qt ? '100px' : '50px',
      transform: 'translate(-50%, -50%)',
      pointerEvents: 'none',
      zIndex: '999',
    }),
      this.appendChild(this.ripple),
      (this.ripple.primary = !0),
            ...
            () => {
              (this.cancelled = !0),
                this.timer &&
                  ...
                  this.isRepeating &&
                    this.repeatTimeout &&
                    (clearInterval(this.repeatTimeout), (this.isRepeating = !1)));
            },
            { passive: !0 }
          );
        }
  ...
  bind(t, e) {
    (t.actionHandler && Kt(e, t.actionHandler.options)) ||
      (t.actionHandler
        ? (t.removeEventListener('touchstart', t.actionHandler.start),
          t.removeEventListener('touchend', t.actionHandler.end),
          t.removeEventListener('touchcancel', t.actionHandler.end),
          t.removeEventListener('mousedown', t.actionHandler.start),
          t.removeEventListener('click', t.actionHandler.end),
          t.removeEventListener('keyup', t.actionHandler.handleEnter))
      ...
      (t.actionHandler = { options: e }),
      e.disabled ||
        ((t.actionHandler.start = (i) => {
          let n, r;
          (this.cancelled = !1),
            i.touches
              ? ((n = i.touches[0].pageX), (r = i.touches[0].pageY))
              : ((n = i.pageX), (r = i.pageY)),
            e.hasHold &&
              ((this.held = !1),
              (this.timer = window.setTimeout(() => {
                this.startAnimation(n, r),
                  (this.held = !0),
                  e.repeat &&
                    !this.isRepeating &&
                    ((this.isRepeating = !0),
                    (this.repeatTimeout = setInterval(() => {
                      Xt(t, 'action', { action: 'hold' });
                    }, e.repeat)));
              }, this.holdTime)));
        }),
        (t.actionHandler.end = (t) => {
          if (['touchend', 'touchcancel'].includes(t.type) && this.cancelled)
            return void (
              this.isRepeating &&
              this.repeatTimeout &&
              (clearInterval(this.repeatTimeout), (this.isRepeating = !1))
          ...
          t.cancelable && t.preventDefault(),
            e.hasHold &&
              (clearTimeout(this.timer),
              this.isRepeating && this.repeatTimeout && clearInterval(this.repeatTimeout),
              (this.isRepeating = !1),
              this.stopAnimation(),
              (this.timer = void 0)),
            e.hasHold && this.held
              ? e.repeat || Xt(i, 'action', { action: 'hold' })
              : e.hasDoubleClick
              ? ('click' === t.type && t.detail < 2) || !this.dblClickTimeout
                ? (this.dblClickTimeout = window.setTimeout(() => {
                    (this.dblClickTimeout = void 0), Xt(i, 'action', { action: 'tap' });
                  }, 250))
                : (clearTimeout(this.dblClickTimeout),
                  (this.dblClickTimeout = void 0),
                  Xt(i, 'action', { action: 'double_tap' }))
              : Xt(i, 'action', { action: 'tap' });
        }),
        (t.actionHandler.handleEnter = (t) => {
          13 === t.keyCode && t.currentTarget.actionHandler.end(t);
        }),
        t.addEventListener('touchstart', t.actionHandler.start, { passive: !0 }),
        t.addEventListener('touchend', t.actionHandler.end),
        t.addEventListener('touchcancel', t.actionHandler.end),
        t.addEventListener('mousedown', t.actionHandler.start, { passive: !0 }),
        t.addEventListener('click', t.actionHandler.end),
        t.addEventListener('keyup', t.actionHandler.handleEnter)));
  }
  startAnimation(t, e) {
    Object.assign(this.style, { left: t + 'px', top: e + 'px', display: null }),
      (this.ripple.disabled = !1),
      this.ripple.startPress(),
      (this.ripple.unbounded = !0);
  }
  stopAnimation() {
    this.ripple.endPress(), (this.ripple.disabled = !0), (this.style.display = 'none');
  }
}
customElements.define('button-card-action-handler', te);
const ee = (t, e) => {
    const i = (() => {
      const t = document.body;
      if (t.querySelector('button-card-action-handler'))
        return t.querySelector('button-card-action-handler');
      const e = document.createElement('button-card-action-handler');
      return t.appendChild(e), e;
    })();
    i && i.bind(t, e);
  },
  ie = g((t = {}) => (e) => {
    ee(e.committer.element, t);
  });
function ne(t, e) {
  (function (t) {
...
function le(t, e, i) {
  (t = ne(t, 255)), (e = ne(e, 255)), (i = ne(i, 255));
  ...
  if (n === r) (a = 0), (s = 0);
    ...
    var l = n - r;
    switch (((a = o > 0.5 ? l / (2 - n - r) : l / (n + r)), n)) {
      case t:
        s = (e - i) / l + (e < i ? 6 : 0);
        break;
      case e:
...
function ce(t, e, i) {
  return (
    i < 0 && (i += 1),
    i > 1 && (i -= 1),
    i < 1 / 6 ? t + 6 * i * (e - t) : i < 0.5 ? e : i < 2 / 3 ? t + (e - t) * (2 / 3 - i) * 6 : t
  );
}
function he(t, e, i) {
  (t = ne(t, 255)), (e = ne(e, 255)), (i = ne(i, 255));
  ...
  return (
    'string' == typeof t &&
      (t = (function (t) {
        ...
        var i = ve.rgb.exec(t);
        if (i) return { r: i[1], g: i[2], b: i[3] };
        if ((i = ve.rgba.exec(t))) return { r: i[1], g: i[2], b: i[3], a: i[4] };
        if ((i = ve.hsl.exec(t))) return { h: i[1], s: i[2], l: i[3] };
        if ((i = ve.hsla.exec(t))) return { h: i[1], s: i[2], l: i[3], a: i[4] };
        if ((i = ve.hsv.exec(t))) return { h: i[1], s: i[2], v: i[3] };
        if ((i = ve.hsva.exec(t))) return { h: i[1], s: i[2], v: i[3], a: i[4] };
        if ((i = ve.hex8.exec(t)))
          return {
            r: fe(i[1]),
            g: fe(i[2]),
        ...
        if ((i = ve.hex6.exec(t)))
          return { r: fe(i[1]), g: fe(i[2]), b: fe(i[3]), format: e ? 'name' : 'hex' };
        if ((i = ve.hex4.exec(t)))
          return {
            r: fe(i[1] + i[1]),
            g: fe(i[2] + i[2]),
    ...
    'object' == typeof t &&
      (we(t.r) && we(t.g) && we(t.b)
        ? ((e = (function (t, e, i) {
            return { r: 255 * ne(t, 255), g: 255 * ne(e, 255), b: 255 * ne(i, 255) };
          })(t.r, t.g, t.b)),
          (a = !0),
          (o = '%' === String(t.r).substr(-1) ? 'prgb' : 'rgb'))
        : we(t.h) && we(t.s) && we(t.v)
        ? ((n = ae(t.s)),
          (r = ae(t.v)),
          (e = (function (t, e, i) {
            (t = 6 * ne(t, 360)), (e = ne(e, 100)), (i = ne(i, 100));
            var n = Math.floor(t),
              r = t - n,
              s = i * (1 - e),
              a = i * (1 - r * e),
        ...
        : we(t.h) &&
          ...
          (e = (function (t, e, i) {
            var n, r, s;
            if (((t = ne(t, 360)), (e = ne(e, 100)), (i = ne(i, 100)), 0 === e))
              (r = i), (s = i), (n = i);
            else {
              var a = i < 0.5 ? i * (1 + e) : i + e - i * e,
                o = 2 * i - a;
              (n = ce(o, a, t + 1 / 3)), (r = ce(o, a, t)), (s = ce(o, a, t - 1 / 3));
            }
...
function we(t) {
  return Boolean(ve.CSS_UNIT.exec(String(t)));
}
var Se = (function () {
  function t(e, i) {
    var n;
    ...
    (this.originalInput = e),
      ...
      (this.format = null !== (n = i.format) && void 0 !== n ? n : r.format),
  ...
  return (
    ...
    (t.prototype.getLuminance = function () {
      ...
      return (
        ...
        0.7152 * (i <= 0.03928 ? i / 12.92 : Math.pow((i + 0.055) / 1.055, 2.4)) +
    ...
    (t.prototype.toHslString = function () {
      ...
      return 1 === this.a
        ? 'hsl(' + e + ', ' + i + '%, ' + n + '%)'
        : 'hsla(' + e + ', ' + i + '%, ' + n + '%, ' + this.roundA + ')';
    }),
    (t.prototype.toHex = function (t) {
      return void 0 === t && (t = !1), ue(this.r, this.g, this.b, t);
    }),
    ...
    (t.prototype.toRgbString = function () {
      ...
      return 1 === this.a
        ? 'rgb(' + t + ', ' + e + ', ' + i + ')'
        : 'rgba(' + t + ', ' + e + ', ' + i + ', ' + this.roundA + ')';
    }),
    (t.prototype.toPercentageRgb = function () {
      var t = function (t) {
        return Math.round(100 * ne(t, 255)) + '%';
      };
    ...
    (t.prototype.toName = function () {
      ...
      for (
        var t = '#' + ue(this.r, this.g, this.b, !1), e = 0, i = Object.entries(ge);
        e < i.length;
        e++
      ) {
        var n = i[e],
    ...
    (t.prototype.lighten = function (e) {
      void 0 === e && (e = 10);
      var i = this.toHsl();
      return (i.l += e / 100), (i.l = re(i.l)), new t(i);
    }),
    (t.prototype.brighten = function (e) {
      void 0 === e && (e = 10);
      var i = this.toRgb();
      return (
        (i.r = Math.max(0, Math.min(255, i.r - Math.round((-e / 100) * 255)))),
    ...
    (t.prototype.desaturate = function (e) {
      void 0 === e && (e = 10);
      var i = this.toHsl();
      return (i.s -= e / 100), (i.s = re(i.s)), new t(i);
    }),
    ...
    (t.prototype.spin = function (e) {
      var i = this.toHsl(),
        n = (i.h + e) % 360;
      return (i.h = n < 0 ? 360 + n : n), new t(i);
    }),
    ...
    (t.prototype.monochromatic = function (e) {
      void 0 === e && (e = 6);
      for (var i = this.toHsv(), n = i.h, r = i.s, s = i.v, a = [], o = 1 / e; e--; )
        a.push(new t({ h: n, s: r, v: s })), (s = (s + o) % 1);
      return a;
    }),
    (t.prototype.splitcomplement = function () {
      ...
      return [
        this,
        new t({ h: (i + 72) % 360, s: e.s, l: e.l }),
        new t({ h: (i + 216) % 360, s: e.s, l: e.l }),
      ];
    }),
    ...
    (t.prototype.polyad = function (e) {
      for (var i = this.toHsl(), n = i.h, r = [this], s = 360 / e, a = 1; a < e; a++)
        r.push(new t({ h: (n + a * s) % 360, s: i.s, l: i.l }));
      return r;
    }),
...
function xe(t, e) {
  return void 0 === t && (t = ''), void 0 === e && (e = {}), new Se(t, e);
}
function ke(t) {
  return t.substr(0, t.indexOf('.'));
}
function Oe(t) {
  return 'var' === t.substring(0, 3)
    ? window
        .getComputedStyle(document.documentElement)
        .getPropertyValue(t.substring(4).slice(0, -1))
        .trim()
    : t;
}
function Te(t, e) {
  const i = new Se(Oe(t));
  if (i.isValid) {
    const t = i.mix('black', 100 - e).toString();
    if (t) return t;
  }
  return t;
}
function Me(...t) {
  const e = (t) => t && 'object' == typeof t;
  return t.reduce(
    (t, i) => (
...
function Ce(t, e) {
  ...
  return (
    ...
    e && (i = i.concat(e.filter((e) => !t || !t.find((t) => !(!t.id || !e.id) && t.id == e.id)))),
    i
  );
}
const Ee = ((t, ...e) => {
...
const Ae = (t, e, i, n) => {
  if (
    !((t, e, i) => {
      const [n, r] = t.split('.', 2);
      return Number(n) > e || (Number(n) === e && Number(r) >= i);
    })(t.config.version, 0, 109)
  )
    return (function (t, e) {
      let i;
      const n = ke(e.entity_id);
      return (
        'binary_sensor' === n
          ? (e.attributes.device_class &&
              (i = t(`state.${n}.${e.attributes.device_class}.${e.state}`)),
            i || (i = t(`state.${n}.default.${e.state}`)))
          : (i =
              e.attributes.unit_of_measurement && !['unknown', 'unavailable'].includes(e.state)
                ? e.state
                : 'zwave' === n
                ? ['initializing', 'dead'].includes(e.state)
                  ? t('state.zwave.query_stage.' + e.state, 'query_stage', e.attributes.query_stage)
                  : t('state.zwave.default.' + e.state)
                : t(`state.${n}.${e.state}`)),
        i || (i = t('state.default.' + e.state) || t(`component.${n}.state.${e.state}`) || e.state),
        i
      );
    })(e, i);
  if ('unknown' === i.state || 'unavailable' === i.state) return e('state.default.' + i.state);
  if (i.attributes.unit_of_measurement) return `${i.state} ${i.attributes.unit_of_measurement}`;
  const r = ke(i.entity_id);
  if ('input_datetime' === r) {
    let t;
    if (!i.attributes.has_time)
      return (t = new Date(i.attributes.year, i.attributes.month - 1, i.attributes.day)), jt(t, n);
    if (!i.attributes.has_date) {
      const e = new Date();
      return (
        (t = new Date(
          e.getFullYear(),
  ...
  return (
    (i.attributes.device_class &&
      e(`component.${r}.state.${i.attributes.device_class}.${i.state}`)) ||
    e(`component.${r}.state._.${i.state}`) ||
    i.state
  );
};
var Ne = Function.prototype.toString,
  ...
  Fe = De.propertyIsEnumerable,
  Ie = 'function' == typeof Re,
  ze = 'function' == typeof WeakMap,
  Ue = function (t, e) {
    if (!t.constructor) return Pe(null);
    var i = t.constructor,
      n = t.__proto__ || Ve(t);
    if (i === e.Object) return n === e.Object.prototype ? {} : Pe(n);
    if (~Ne.call(i).indexOf('[native code]'))
      try {
        return new i();
      } catch (r) {}
    return Pe(n);
  ...
  qe = function (t, e, i, n) {
    var r = Ue(t, e);
    for (var s in (n.set(t, r), t)) Le.call(t, s) && (r[s] = i(t[s], n));
    if (Ie) {
      var a = Re(t),
        o = a.length;
      if (o)
        for (var l = 0, c = void 0; l < o; l++) (c = a[l]), Fe.call(t, c) && (r[c] = i(t[c], n));
    }
    return r;
  },
  Ye = function (t, e, i, n) {
    var r = Ue(t, e);
    n.set(t, r);
    var s = Ie ? He(t).concat(Re(t)) : He(t),
      a = s.length;
    if (a)
      for (var o = 0, l = void 0, c = void 0; o < a; o++)
        if ('callee' !== (l = s[o]) && 'caller' !== l)
          if ((c = $e(t, l))) {
            c.get || c.set || (c.value = i(t[l], n));
            try {
              je(r, l, c);
            } catch (h) {
              r[l] = c.value;
...
function Ge(t, e) {
  var i = !(!e || !e.isStrict),
    ...
    s = function (t, e) {
      ...
      var a,
        ...
        l,
        c = t.constructor;
      if (c === n.Object) return r(t, n, s, e);
      if (Be(t)) {
        if (i) return Ye(t, n, s, e);
        var h = t.length;
        (a = new c()), e.set(t, a);
        for (var u = 0; u < h; u++) a[u] = s(t[u], e);
        return a;
      }
      if (t instanceof n.Date) return new c(t.getTime());
      ...
      if (n.Blob && t instanceof n.Blob) return (a = new Blob([t], { type: t.type }));
      if (n.Buffer && n.Buffer.isBuffer(t))
        return (
          (a = n.Buffer.allocUnsafe ? n.Buffer.allocUnsafe(t.length) : new c(t.length)),
          e.set(t, a),
          t.copy(a),
          a
        );
      if (n.ArrayBuffer) {
        if (n.ArrayBuffer.isView(t)) return (a = new c(t.buffer.slice(0))), e.set(t, a), a;
        if (t instanceof n.ArrayBuffer) return (a = t.slice(0)), e.set(t, a), a;
      }
  ...
  return s(
    t,
    (function () {
      if (ze) return new WeakMap();
      var t = Pe({
        has: function (e) {
          return !!~t._keys.indexOf(e);
        },
        set: function (e, i) {
          t._keys.push(e), t._values.push(i);
        },
        get: function (e) {
          return t._values[t._keys.indexOf(e)];
        },
      });
      return (t._keys = []), (t._values = []), t;
    })()
  );
}
Ge.strict = function (t, e) {
  return Ge(t, { isStrict: !0, realm: e ? e.realm : void 0 });
};
let Ze = window.cardHelpers;
const Je = new Promise(async (t) => {
  Ze && t(),
    window.loadCardHelpers &&
      ((Ze = await window.loadCardHelpers()), (window.cardHelpers = Ze), t());
});
console.info(
  '%c  BUTTON-CARD  \n%c Version 3.4.0 ',
...
let Xe = class extends nt {
  constructor() {
    super(...arguments),
      (this._cards = {}),
      (this._cardsConfig = {}),
      (this._entities = []),
      (this._initial_setup_complete = !1),
      (this._rippleHandlers = new rt(() => this._ripple));
  }
  set hass(t) {
    (this._hass = t),
      Object.keys(this._cards).forEach((t) => {
  ...
  connectedCallback() {
    super.connectedCallback(),
      this._initial_setup_complete ? this._startTimerCountdown() : this._initConnected();
  }
  _initConnected() {
    void 0 !== this._hass &&
      void 0 !== this._config &&
      this.isConnected &&
      ((this._initial_setup_complete = !0), this._startTimerCountdown());
  }
  _startTimerCountdown() {
    if (this._config && this._config.entity && 'timer' === ke(this._config.entity)) {
      const t = this._hass.states[this._config.entity];
      this._startInterval(t);
    }
  }
  _createCard(t) {
    if (Ze) return Ze.createCardElement(t);
    {
      const e = (function (t, e) {
        ...
        if (!t || 'object' != typeof t || (!e && !t.type)) return i('No type defined', t);
        var r = t.type;
        if (r && r.startsWith('custom:')) r = r.substr('custom:'.length);
        else if (e)
          if (zt.has(r)) r = 'hui-' + r + '-row';
          else {
            if (!t.entity) return i('Invalid config given.', t);
            var s = t.entity.split('.', 1)[0];
            r = 'hui-' + (Ut[s] || 'text') + '-entity-row';
          }
        else r = 'hui-' + r + '-card';
        if (customElements.get(r)) return n(r, t);
        var a = i("Custom element doesn't exist: " + t.type + '.', t);
        a.style.display = 'None';
        var o = setTimeout(function () {
          a.style.display = '';
        }, 2e3);
        return (
          customElements.whenDefined(t.type).then(function () {
  ...
  render() {
    ...
    this._stateObj = this._config.entity ? this._hass.states[this._config.entity] : void 0;
    try {
      return (
      ...
      t.stack ? console.error(t.stack) : console.error(t);
      const e = document.createElement('hui-error-card');
      return (
        e.setConfig({ type: 'error', error: t.toString(), origConfig: this._config }), D` ${e} `
      );
    }
  }
  shouldUpdate(t) {
    return (
      ...
      ) && (this._expandTriggerGroups(), !0)
    );
  }
  updated(t) {
    if (
      (super.updated(t),
      this._config && this._config.entity && 'timer' === ke(this._config.entity) && t.has('_hass'))
    ) {
      const e = this._hass.states[this._config.entity],
        i = t.get('_hass');
      (i ? i.states[this._config.entity] : void 0) !== e
        ? this._startInterval(e)
        : e || this._clearInterval();
    }
  }
  _clearInterval() {
  ...
  _startInterval(t) {
    this._clearInterval(),
      this._calculateRemaining(t),
      'active' === t.state &&
        (this._interval = window.setInterval(() => this._calculateRemaining(t), 1e3));
  }
  _calculateRemaining(t) {
    t.attributes.remaining &&
      (this._timeRemaining = (function (t) {
        var e = Pt(t.attributes.remaining);
        if ('active' === t.state) {
          var i = new Date().getTime(),
            n = new Date(t.last_changed).getTime();
          e = Math.max(e - (i - n) / 1e3, 0);
        }
        return e;
      })(t));
  }
  ...
  _getMatchingConfigState(t) {
    if (!this._config.state) return;
    const e = this._config.state.find((t) => 'template' === t.operator);
    if (!t && !e) return;
    let i;
    const n = this._config.state.find((e) => {
      if (!e.operator) return t && this._getTemplateOrValue(t, e.value) == t.state;
      switch (e.operator) {
        case '==':
          return t && t.state == this._getTemplateOrValue(t, e.value);
        case '<=':
          return t && t.state <= this._getTemplateOrValue(t, e.value);
        case '<':
          return t && t.state < this._getTemplateOrValue(t, e.value);
        ...
        case '!=':
          return t && t.state != this._getTemplateOrValue(t, e.value);
        case 'regex':
          return !(!t || !t.state.match(this._getTemplateOrValue(t, e.value)));
        case 'template':
          return this._getTemplateOrValue(t, e.value);
        case 'default':
          return (i = e), !1;
        default:
          return !1;
  ...
  _evalTemplate(t, e) {
    try {
      return new Function(
        ...
        'html',
        "'use strict'; " + e
      ).call(this, this._hass.states, t, this._hass.user, this._hass, this._evaledVariables, D);
    } catch (i) {
      const t = e.length <= 100 ? e.trim() : e.trim().substring(0, 98) + '...';
      throw (
        ((i.message = `${i.name}: ${i.message} in '${t}'`),
        (i.name = 'ButtonCardJSTemplateError'),
        i)
      );
    }
  }
  ...
  _getTemplateOrValue(t, e) {
    if (['number', 'boolean'].includes(typeof e)) return e;
    if (!e) return e;
    if ('object' == typeof e)
      return (
    ...
    const i = e.trim();
    return '[[[' === i.substring(0, 3) && ']]]' === i.slice(-3)
      ? this._evalTemplate(t, i.slice(3, -3))
      : e;
  }
  ...
  _getColorForLightEntity(t, e) {
    let i = this._config.default_color;
    return (
      t &&
        ('on' === t.state
          ? t.attributes.rgb_color
            ? ((i = `rgb(${t.attributes.rgb_color.join(',')})`),
              t.attributes.brightness && (i = Te(i, (t.attributes.brightness + 245) / 5)))
            : e && t.attributes.color_temp && t.attributes.min_mireds && t.attributes.max_mireds
            ? ((i = (function (t, e, i) {
                const n = new Se('rgb(255, 160, 0)'),
                  r = new Se('rgb(166, 209, 255)'),
                  s = new Se('white'),
                  a = ((t - e) / (i - e)) * 100;
                return a < 50
                  ? xe(r)
                  ...
                  : xe(s)
                      .mix(n, 2 * (a - 50))
                      .toRgbString();
              })(t.attributes.color_temp, t.attributes.min_mireds, t.attributes.max_mireds)),
              t.attributes.brightness && (i = Te(i, (t.attributes.brightness + 245) / 5)))
            : (i = t.attributes.brightness
                ? Te(this._getDefaultColorForState(t), (t.attributes.brightness + 245) / 5)
                : this._getDefaultColorForState(t))
          : (i = this._getDefaultColorForState(t))),
      i
    );
  }
  _buildCssColorAttribute(t, e) {
    ...
    return (
      (null == e ? void 0 : e.color)
        ? (n = e.color)
        : 'auto' !== this._config.color && 'off' === (null == t ? void 0 : t.state)
        ? (n = this._config.color_off)
        : this._config.color && (n = this._config.color),
      (i =
        'auto' == n || 'auto-no-temperature' == n
          ? this._getColorForLightEntity(t, 'auto-no-temperature' !== n)
          : n || (t ? this._getDefaultColorForState(t) : this._config.default_color)),
      i
    );
  }
  _buildIcon(t, e) {
    if (!this._config.show_icon) return;
    let i;
    if (null == e ? void 0 : e.icon) i = e.icon;
    else if (this._config.icon) i = this._config.icon;
    else {
      if (!t) return;
      i = (function (t) {
        if (!t) return Dt;
        if (t.attributes.icon) return t.attributes.icon;
        var e = Vt(t.entity_id);
        return e in Jt ? Jt[e](t) : Yt(e, t.state);
      })(t);
    }
    return this._getTemplateOrValue(t, i);
  }
  _buildEntityPicture(t, e) {
    if (!this._config.show_entity_picture || (!t && !e && !this._config.entity_picture)) return;
    let i;
    return (
      (null == e ? void 0 : e.entity_picture)
        ? (i = e.entity_picture)
        : this._config.entity_picture
        ? (i = this._config.entity_picture)
        : t &&
          (i = t.attributes && t.attributes.entity_picture ? t.attributes.entity_picture : void 0),
      this._getTemplateOrValue(t, i)
    );
  }
  _buildStyleGeneric(t, e, i) {
    ...
    let s = {};
    if (
      ((null === (n = this._config.styles) || void 0 === n ? void 0 : n[i]) &&
        (s = Object.assign(s, ...this._config.styles[i])),
      null === (r = null == e ? void 0 : e.styles) || void 0 === r ? void 0 : r[i])
    ) {
      let t = {};
      (t = Object.assign(t, ...e.styles[i])), (s = Object.assign(Object.assign({}, s), t));
    }
    return (
  ...
  _buildCustomStyleGeneric(t, e, i) {
    ...
    if (
      ((null ===
        (r = null === (n = this._config.styles) || void 0 === n ? void 0 : n.custom_fields) ||
      void 0 === r
        ? void 0
        : r[i]) && (o = Object.assign(o, ...this._config.styles.custom_fields[i])),
      null ===
        (a =
          null === (s = null == e ? void 0 : e.styles) || void 0 === s
            ? void 0
            : s.custom_fields) || void 0 === a
        ? void 0
        : a[i])
    ) {
      let t = {};
      (t = Object.assign(t, ...e.styles.custom_fields[i])),
        (o = Object.assign(Object.assign({}, o), t));
    }
    return (
      Object.keys(o).forEach((e) => {
        o[e] = this._getTemplateOrValue(t, o[e]);
      }),
      o
    );
  }
  _buildName(t, e) {
    if (!1 === this._config.show_name) return;
    let i;
    var n;
    return (
      (null == e ? void 0 : e.name)
        ...
        : t &&
          (i =
            t.attributes && t.attributes.friendly_name
              ? t.attributes.friendly_name
              : (n = t.entity_id).substr(n.indexOf('.') + 1)),
      this._getTemplateOrValue(t, i)
    );
  }
  _buildStateString(t) {
    var e;
    let i;
    if (this._config.show_state && t && t.state) {
      const n = this._buildUnits(t);
      n
        ? (i = `${t.state} ${n}`)
        : 'timer' === ke(t.entity_id)
        ? 'idle' === t.state || 0 === this._timeRemaining
          ? (i = Ae(this._hass, this._hass.localize, t, this._hass.language))
          : ((i = this._computeTimeDisplay(t)),
            'paused' === t.state &&
              (i += ` (${Ae(this._hass, this._hass.localize, t, this._hass.language)})`))
        : (i =
            (null === (e = this._config) || void 0 === e ? void 0 : e.show_units) ||
            'sensor' !== ke(t.entity_id)
              ? Ae(this._hass, this._hass.localize, t, this._hass.language)
              : t.state);
    }
    return i;
  }
  _buildUnits(t) {
    ...
    return (
      t &&
        this._config.show_units &&
        (i =
          (null === (e = t.attributes) || void 0 === e ? void 0 : e.unit_of_measurement) &&
          !this._config.units
  ...
  _buildLastChanged(t, e) {
    return this._config.show_last_changed && t
      ? D`
          <ha-relative-time
            id="label"
            class="ellipsis"
  ...
  _buildLabel(t, e) {
    ...
    let i;
    return (
      (i = (null == e ? void 0 : e.label) ? e.label : this._config.label),
      this._getTemplateOrValue(t, i)
    );
  }
  _buildCustomFields(t, e) {
    ...
    const n = {},
      r = {};
    return (
      this._config.custom_fields &&
        Object.keys(this._config.custom_fields).forEach((e) => {
          const i = this._config.custom_fields[e];
          i.card
            ? (r[e] = this._objectEvalTemplate(t, i.card))
            : (n[e] = this._getTemplateOrValue(t, i));
        }),
      (null == e ? void 0 : e.custom_fields) &&
        Object.keys(e.custom_fields).forEach((i) => {
          const s = e.custom_fields[i];
          s.card
            ? (r[i] = this._objectEvalTemplate(t, s.card))
            : (n[i] = this._getTemplateOrValue(t, s));
        }),
      Object.keys(n).forEach((r) => {
        if (null != n[r]) {
          const s = Object.assign(Object.assign({}, this._buildCustomStyleGeneric(t, e, r)), {
            'grid-area': r,
          });
          i = D`
          ${i}
      ...
      Object.keys(r).forEach((n) => {
        if (null != r[n]) {
          const s = Object.assign(Object.assign({}, this._buildCustomStyleGeneric(t, e, n)), {
            'grid-area': n,
          });
          let a;
          Kt(this._cardsConfig[n], r[n])
            ? (a = this._cards[n])
            : ((a = this._createCard(r[n])),
              (this._cards[n] = a),
              (this._cardsConfig[n] = Ge(r[n]))),
            (a.hass = this._hass),
            (i = D`
          ${i}
          <div
  ...
  _isClickable(t) {
    let e = !0;
    const i = this._getTemplateOrValue(t, this._config.tap_action.action),
      n = this._getTemplateOrValue(t, this._config.hold_action.action),
      r = this._getTemplateOrValue(t, this._config.double_tap_action.action);
    return (e = 'none' != i || 'none' != n || 'none' != r), e;
  }
  _rotate(t) {
    return !!(null == t ? void 0 : t.spin);
  }
  _blankCardColoredHtml(t) {
    const e = Object.assign({ background: 'none', 'box-shadow': 'none' }, t);
    return D`
  ...
  _cardHtml() {
    var t, e;
    const i = this._getMatchingConfigState(this._stateObj),
      n = this._buildCssColorAttribute(this._stateObj, i);
    let r = n,
      s = {},
      a = {};
    const o = {},
      ...
      u = {
        'button-card-main': !0,
        tooltip: !!(null === (t = this._config) || void 0 === t ? void 0 : t.tooltip),
    ...
    switch (
      ...
      case 'label-card': {
        const t = (function (t) {
          const e = new Se(Oe(t));
          return e.isValid && e.getLuminance() > 0.5 ? 'rgb(62, 62, 62)' : 'rgb(234, 234, 234)';
        })(n);
        (s.color = t),
          (a.color = t),
    ...
    this._config.aspect_ratio
      ? ((o['--aspect-ratio'] = this._config.aspect_ratio), (s.position = 'absolute'))
      : (o.display = 'inline'),
      this.style.setProperty(
        '--button-card-light-color',
        this._getColorForLightEntity(this._stateObj, !0)
      ),
      this.style.setProperty(
        '--button-card-light-color-no-temperature',
        this._getColorForLightEntity(this._stateObj, !1)
      ),
      (a = Object.assign(Object.assign({}, a), l));
    const d = this._config.extra_styles
      ? D`
          <style>
    ...
    return D`
      ...
      <div id="aspect-ratio" style=${at(o)}>
        <ha-card
          ...
          .actionHandler=${ie({
            hasDoubleClick: 'none' !== this._config.double_tap_action.action,
            hasHold: 'none' !== this._config.hold_action.action,
        ...
        >
          ...
          ${
            (null === (e = this._config) || void 0 === e ? void 0 : e.tooltip)
              ? D`
  ...
  _getLock(t) {
    return this._config.lock && this._getTemplateOrValue(this._stateObj, this._config.lock.enabled)
      ? D`
        <div
          id="overlay"
          style=${at(t)}
          ...
          .actionHandler=${ie({
            hasDoubleClick: 'double_tap' === this._config.lock.unlock,
            hasHold: 'hold' === this._config.lock.unlock,
          })}
          .config="${this._config}"
        >
    ...
    const n = this._buildName(t, e),
      r =
        this._config.show_state && this._config.state_display
          ? this._getTemplateOrValue(t, this._config.state_display)
          : void 0,
      s = r || this._buildStateString(t),
      a = (function (t, e) {
        if (!t && !e) return;
        let i;
        return (i = e ? (t ? `${t}: ${e}` : e) : t), i;
      })(n, s);
    switch (this._config.layout) {
      case 'icon_name_state':
      case 'name_state':
        return this._gridHtml(t, e, this._config.layout, i, a, void 0);
      default:
        return this._gridHtml(t, e, this._config.layout, i, n, s);
    }
  }
  _gridHtml(t, e, i, n, r, s) {
    const a = this._getIconHtml(t, e, n),
      ...
      p = this._buildStyleGeneric(t, e, 'grid');
    return (
      a || o.push('no-icon'),
      r || o.push('no-name'),
      s || o.push('no-state'),
      ...
      c = Object.assign(
        {
          ...
          position: this._config.aspect_ratio || l.height ? 'absolute' : 'relative',
        },
        a
      ),
      h = Object.assign(Object.assign({}, c), s),
      u = this._buildLiveStream(h);
    return n || r
      ? D`
  ...
  _buildLiveStream(t) {
    return this._config.show_live_stream &&
      this._config.entity &&
      'camera' === ke(this._config.entity)
      ? D`
        <hui-image
          .hass=${this._hass}
  ...
  _configFromLLTemplates(t, e) {
    ...
    let n,
      r = {};
    const s = i && Array.isArray(i) ? i : [i];
    return (
      null == s ||
        s.forEach((e) => {
          var i;
          if (!(null === (i = t.config.button_card_templates) || void 0 === i ? void 0 : i[e]))
            throw new Error(`Button-card template '${e}' is missing!`);
          const s = this._configFromLLTemplates(t, t.config.button_card_templates[e]);
          (r = Me(r, s)), (n = Ce(n, s.state));
        }),
      (r = Me(r, e)),
      (r.state = Ce(n, e.state)),
      r
    );
  }
  setConfig(t) {
    if (!t) throw new Error('Invalid configuration');
    (this._cards = {}), (this._cardsConfig = {});
    const e =
      (function () {
            ...
            (t =
              (t =
                (t =
                  ((t =
                    (t =
                      (t = (t = t && t.shadowRoot) && t.querySelector('home-assistant-main')) &&
                      t.shadowRoot) &&
                    t.querySelector('app-drawer-layout partial-panel-resolver')) &&
                    t.shadowRoot) ||
                  t) && t.querySelector('ha-panel-lovelace')) && t.shadowRoot) &&
            t.querySelector('hui-root'))
        ) {
          var e = t.lovelace;
      ...
      (function () {
        let t = document.querySelector('hc-main');
        if (
          ((t = t && t.shadowRoot),
          (t = t && t.querySelector('hc-lovelace')),
          (t = t && t.shadowRoot),
          (t = t && (t.querySelector('hui-view') || t.querySelector('hui-panel-view'))),
          t)
        ) {
          const e = t.lovelace;
          return (e.current_view = t.___curView), e;
    ...
    let i = Ge(t);
    (i = this._configFromLLTemplates(e, i)),
      (this._config = Object.assign(
        ...
        ),
        {
          ...
          color_off: 'DUMMY',
          color_on: 'DUMMY',
          lock: Object.assign({ enabled: !1, duration: 5, unlock: 'tap' }, i.lock),
        }
      )),
      this._config.entity && Ft.has(ke(this._config.entity))
    ...
    const n = JSON.stringify(this._config);
    if (
      ((this._entities = []),
      Array.isArray(this._config.triggers_update)
        ? (this._entities = [...this._config.triggers_update])
        : 'string' == typeof this._config.triggers_update &&
          'all' !== this._config.triggers_update &&
      ...
      null == i ||
        i.forEach((t) => {
          const i = t.match(e);
          i && !this._entities.includes(i[2]) && this._entities.push(i[2]);
        });
    }
    this._config.entity &&
      !this._entities.includes(this._config.entity) &&
      this._entities.push(this._config.entity),
      this._expandTriggerGroups();
    const r = new RegExp('\\[\\[\\[.*\\]\\]\\]', 'm');
    (this._hasTemplate = !('all' !== this._config.triggers_update || !n.match(r))),
      this._initial_setup_complete || this._initConnected();
  }
  _loopGroup(t) {
    t &&
      t.forEach((t) => {
        var e, i;
        (null === (e = this._hass) || void 0 === e ? void 0 : e.states[t]) &&
          ('group' === ke(t) &&
          (null === (i = this._hass.states[t].attributes) || void 0 === i ? void 0 : i.entity_id)
            ? this._loopGroup(this._hass.states[t].attributes.entity_id)
            : this._entities.includes(t) || this._entities.push(t));
      });
  }
  _expandTriggerGroups() {
    var t;
    this._hass &&
      (null === (t = this._config) || void 0 === t ? void 0 : t.group_expand) &&
      this._entities &&
      this._entities.forEach((t) => {
        ...
        'group' === ke(t) &&
          this._loopGroup(
            null ===
              (i = null === (e = this._hass) || void 0 === e ? void 0 : e.states[t].attributes) ||
              void 0 === i
              ? void 0
              : i.entity_id
          );
  ...
  getCardSize() {
    var t;
    return (null === (t = this._config) || void 0 === t ? void 0 : t.card_size) || 3;
  }
  _evalActions(t, e) {
    const i = Ge(t),
      n = (t) =>
        t
          ? (Object.keys(t).forEach((e) => {
              'object' == typeof t[e]
                ? (t[e] = n(t[e]))
                : (t[e] = this._getTemplateOrValue(this._stateObj, t[e]));
            }),
            t)
          : t;
    return (
      (i[e] = n(i[e])),
      !i[e].confirmation && i.confirmation && (i[e].confirmation = n(i.confirmation)),
      i
    );
  }
  handleRippleActivate(t) {
    this._ripple.then((e) => e && e.startPress && this._rippleHandlers.startPress(t));
  }
  handleRippleDeactivate() {
    this._ripple.then((t) => t && t.endPress && this._rippleHandlers.endPress());
  }
  handleRippleFocus() {
    this._ripple.then((t) => t && t.startFocus && this._rippleHandlers.startFocus());
  }
  handleRippleBlur() {
    this._ripple.then((t) => t && t.endFocus && this._rippleHandlers.endFocus());
  }
  _handleAction(t) {
    var e;
    if (null === (e = t.detail) || void 0 === e ? void 0 : e.action)
  ...
  _handleTap() {
    ...
    t && Gt(this, this._hass, this._evalActions(t, 'tap_action'), !1, !1);
  }
  _handleHold() {
    const t = this._config;
    t && Gt(this, this._hass, this._evalActions(t, 'hold_action'), !0, !1);
  }
  _handleDblTap() {
    const t = this._config;
    t && Gt(this, this._hass, this._evalActions(t, 'double_tap_action'), !1, !0);
  }
  _handleUnlockType(t) {
    const e = this._config;
    e && e.lock.unlock === t.detail.action && this._handleLock();
  }
  _handleLock() {
    const t = this.shadowRoot.getElementById('lock');
    if (!t) return;
    if (this._config.lock.exemptions) {
      if (!this._hass.user.name || !this._hass.user.id) return;
      let e = !1;
      if (
        (this._config.lock.exemptions.forEach((t) => {
          ((!e && t.user === this._hass.user.id) || t.username === this._hass.user.name) &&
            (e = !0);
        }),
        !e)
      )
    ...
    if ((e.style.setProperty('pointer-events', 'none'), t)) {
      const e = document.createAttribute('icon');
      (e.value = 'mdi:lock-open-outline'), t.attributes.setNamedItem(e), t.classList.add('hidden');
    }
    window.setTimeout(() => {
      if ((e.style.setProperty('pointer-events', ''), t)) {
        t.classList.remove('hidden');
        const e = document.createAttribute('icon');
        (e.value = 'mdi:lock-outline'), t.attributes.setNamedItem(e);
      }
...
var Ke, Qe, ti;
t([J()], Xe.prototype, '_hass', void 0),
  t([J()], Xe.prototype, '_config', void 0),
  t([J()], Xe.prototype, '_timeRemaining', void 0),
  t(
    [
      ((Ke = 'mwc-ripple'),
      (t, e) => {
        const i = {
          async get() {
            return await this.updateComplete, this.renderRoot.querySelector(Ke);
          },
          enumerable: !0,
          configurable: !0,
        };
        return void 0 !== e ? X(i, t, e) : K(i, t);
      }),
    ],
    Xe.prototype,
    '_ripple',
  ...
  (Xe = t(
    [
      ...
      (t) =>
        'function' == typeof t
          ? ((t, e) => (window.customElements.define(t, e), e))(ti, t)
          : ((t, e) => {
