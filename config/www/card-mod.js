!(function (e) {
  ...
  function (e, t, o) {
    ...
    const p = async (e) => {
      ...
      return document.createElement('developer-tools-event')._computeParsedEventData(e);
    };
    async function u(e, t, o = !1) {
      let n = e;
      'string' == typeof t && (t = t.split(/(\$| )/)), '' === t[t.length - 1] && t.pop();
    ...
    const m = { template: '', variables: {}, entity_ids: [] },
      y = async (e, t, o, n, r, a = !0) => {
        if (
          (e.localName.includes('-') && (await customElements.whenDefined(e.localName)),
          e.updateComplete && (await e.updateComplete),
          e.modElement)
        )
          return y(e.modElement, t, o, n, r, a);
    ...
    class f extends n {
      ...
      connectedCallback() {
        super.connectedCallback(), (this.template = this._data), this.setAttribute('slot', 'none');
      }
      async getTheme() {
        if (!this.type) return null;
        let e = this.parentElement ? this.parentElement : this;
        const t = window.getComputedStyle(e).getPropertyValue('--card-mod-theme'),
          o = a().themes.themes;
        return o[t]
      ...
      async _setTemplate(e) {
        this._parent ||
          ...
          'string' == typeof e.theme_template && (e.theme_template = { '.': e.theme_template })),
            ...
            void (
              ...
              (this._renderer = await (function (e, t, o) {
                ...
                return e.subscribeMessage(
                  ...
                  { type: 'render_template', template: r, variables: n, entity_ids: s }
                );
              })(
                null,
                (e) => {
            ...
            if (((o = await h(i, e, !0)), o.length))
              for (const a of o) {
                ...
                (o && o._parent === (this._parent || this)) ||
                  ...
                  (o.template = { template: t[e], variables: n, entity_ids: r }),
                  a.appendChild(o),
    ...
    if (!customElements.get('card-mod')) {
      ...
      const e = o(0);
      console.info(`%cCARD-MOD ${e.version} IS INSTALLED`, 'color: green; font-weight: bold', '');
    }
    function g(e, t, o = null) {
      if ((((e = new Event(e, { bubbles: !0, cancelable: !1, composed: !0 })).detail = t || {}), o))
        o.dispatchEvent(e);
      else {
        var n = (function () {
          ...
          return (e = e
            ? ((e =
                (e = (e = e && e.shadowRoot) && e.querySelector('hc-lovelace')) && e.shadowRoot) &&
                              ...
                              (e =
                                (e =
                                  (e =
                                    ...
                                    e.shadowRoot) && e.querySelector('home-assistant-main')) &&
                                e.shadowRoot) &&
                              e.querySelector('app-drawer-layout partial-panel-resolver')) &&
                              e.shadowRoot) ||
                            e) && e.querySelector('ha-panel-lovelace')) && e.shadowRoot) &&
                      e.querySelector('hui-root')) && e.shadowRoot) &&
                  e.querySelector('ha-app-layout')) && e.querySelector('#view')) &&
              e.firstElementChild);
        })();
        n && n.dispatchEvent(e);
      }
    ...
    customElements.whenDefined('ha-card').then(() => {
      ...
      (e.prototype.firstUpdated = function (e) {
        o && o.bind(this)(e);
        const n = this.shadowRoot.querySelector('.card-header');
        n && this.insertBefore(n, this.children[0]);
        const r = t(this);
        if (!r) return;
        r.class && this.classList.add(r.class),
          r.type && this.classList.add('type-' + r.type.replace(':', '-'));
        (() => {
          y(this, 'card', r.style, { config: r }, r.entity_ids, !1);
        })();
      }),
        g('ll-rebuild', {});
    }),
      customElements.whenDefined('hui-entities-card').then(() => {
        ...
        (e.prototype.renderEntity = function (e) {
          ...
          return r(), o.values[0] && o.values[0].addEventListener('ll-rebuild', r), o;
        }),
          g('ll-rebuild', {});
      }),
      customElements.whenDefined('hui-glance-card').then(() => {
        ...
        (e.prototype.firstUpdated = function (e) {
          t && t.bind(this)(e);
          this.shadowRoot.querySelectorAll('ha-card div.entity').forEach((e) => {
      ...
      customElements.whenDefined('hui-state-label-badge').then(() => {
        ...
        (e.prototype.firstUpdated = function (e) {
          ...
          (() => {
            y(this, 'badge', o.style, { config: o }, o.entity_ids);
          })();
        }),
          g('ll-rebuild', {});
      }),
      ...
      customElements.whenDefined('hui-root').then(() => {
        ...
        (o = o && o.shadowRoot),
          ...
          (o = o && o.shadowRoot),
          (o = o && o.querySelector('app-drawer-layout partial-panel-resolver')),
        ...
        e.prototype.showDialog = function (e) {
          ...
          t.bind(this)(e),
            this.requestUpdate().then(async () => {
              await this.shadowRoot.querySelector('ha-dialog').updateComplete, o();
            });
        };
        let o = document.querySelector('home-assistant');
        (o = o && o.shadowRoot),
      ...
      window.loadCardHelpers
        ...
        : window.addEventListener('load', async () => {
            !(async function () {
              ...
              const e = document.createElement('partial-panel-resolver');
              if (
                ((e.hass = { panels: [{ url_path: 'tmp', component_name: 'lovelace' }] }),
                e._updateRoutes(),
                await e.routerOptions.routes.tmp.load(),
    ...
    function b(e, t) {
      if (!t || 'object' != typeof t || !t.type) return v(`No ${e} type configured`, t);
      let o = t.type;
      if (
        ((o = o.startsWith('custom:') ? o.substr('custom:'.length) : `hui-${o}-${e}`),
