...
| `pyscript/`          | Python scripts — persisted system-health AI review                                                       |
...
- 🩺 **System health** — one aggregate sensor watches repairs, low batteries, stuck-unavailable entities and pending updates, then sends a read-only AI review to phone (immediate, daily until fixed, clears on recovery)
